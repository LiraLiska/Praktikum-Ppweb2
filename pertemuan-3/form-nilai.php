...
<form method="post" action="hasil-nilai.php">
  ...
  <div class="form-group row">
    ...
    <div class="col-8">
      <input id="nim" name="nim" placeholder="masukan nim nya" type="text" class="form-control" required="required">
    </div>
  </div>
  <div class="form-group row">
  ...
  <div class="form-group row">
    ...
    <div class="col-8">
      <input id="tugas" name="tugas" placeholder="masukan nilai tugas kamu" type="text" class="form-control" required="required">
    </div>
  </div>
  <div class="form-group row">
